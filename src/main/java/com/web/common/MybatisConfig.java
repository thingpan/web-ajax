...
public class MybatisConfig {
	...
	public static void main(String[] args) {
				try(SqlSession session =getSqlSessionFactory().openSession()){
					List<UserInfoVO> list =session.selectList("com.web.mapper.UserInfoMapper.selectUserInfoList",null);
					...
					int uiNum =2;
					UserInfoVO user =session.selectOne("com.web.mapper.UserInfoMapper.selectUserInfo",2);
